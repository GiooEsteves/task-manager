...
// @desc Exporta as tasks como arquivo excel
...
const exportTasksReport = async (req, res) => {
    try{
        ...
        const worksheet = worbook.addWorksheet("Tasks Report");
        ...
        task.forEach((task) => {
            ...
            worksheet.addRow({
                ...
                assignedTo: assignedTo || "Não inscrito"
            });
        });
        ...
        res.status(500).json({ message: "Erro ao exportar tasks", error: error.message });
    }
};

// @desc Exporta as tasks e os user como arquivo excel
...
const exportUsersReport = async (req, res) => {
    try{
        ...
        const worksheet = new workbook.addWorksheet("User Task Report");
